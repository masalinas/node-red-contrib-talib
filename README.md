...
TA-Lib RED are Node-RED nodes for all TA-Lib indicators, a widely used **Technical Analysis Library for trading**. TA-Lib RED used the javascript version called [node-talib](https://github.com/oransel/node-talib)
